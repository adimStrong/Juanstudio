...
const navItems = [
  ...
  // { path: '/comments', label: 'Comments', icon: '💬' },  // Hidden for now
    ...
    <div className="flex min-h-screen">
      ...
      `}>
        <div className="p-4 flex items-center gap-3">
          <img src="/logo.jpg" alt="JuanStudio Logo" className="w-10 h-10 rounded-full object-cover" />
          <div>
            <h1 className="text-lg font-bold">JuanStudio</h1>
      ...
      <div className="flex-1 flex flex-col min-h-screen md:ml-0">
        ...
        <header className="md:hidden bg-indigo-900 text-white p-3 flex items-center gap-3 sticky top-0 z-20">
          ...
          <span className="font-semibold">JuanStudio</span>
        </header>
