  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center flex-wrap gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">JuanStudio Dashboard</h1>
        ...
        <ResponsiveContainer width="100%" height={450}>
          <BarChart data={pageComparison} layout="vertical">
            ...
            <YAxis
              ...
              fontSize={11}
              width={130}
              tickFormatter={(val) => val?.replace('JuanKada ', '').replace('JUANKada ', '').replace('Juankada ', '')}
            />
            <Tooltip
      ...
      {/* Page Stats Table */}
      <div className="bg-white rounded-lg shadow p-6">
        <h2 className="text-lg font-semibold mb-4">{pageComparison?.length || 0} Pages Performance Summary</h2>
              ...
              {pageComparison.map((page, index) => (
                ...
                >
                  <td className="py-3 font-medium whitespace-nowrap">
                    {page.page_name?.replace('JuanKada ', '').replace('JUANKada ', '').replace('Juankada ', '')}
                    {index === 0 && (
